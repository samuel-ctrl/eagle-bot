            ...
            <div className={Style.panel_body}>
              <div className={Style.sub_content_section}>
                ...
                <p>
                  ...
                  revolutionize customer engagement across various platforms.
                  Hold on to your seats for the official release on{" "}
                ...
                <p></p>
                <p>
                  Customers relying on Microsoft tools can now leverage
                  AI-powered Eagle Bot for seamless operations. From scheduling
                  meetings to executing routine tasks, Eagle Bot ensures that
                  your business performs at its best.
                </p>

                <h2>
                  Google: Access Information Seamlessly with AI and Automate
                  Tasks
                </h2>
                <p></p>
                <p>
                  Eagle Bot, integrated with Google products, provides real-time
                  information and intelligent responses that adapt to user
                  needs. Make content easily accessible and engage effectively,
                  regardless of the platform. Plus, automate tasks such as
                  sending emails and scheduling meetings to boost productivity.
                </p>
                ...
                <p>
                  ...
                  rely on AI-powered Eagle Bot to streamline their efforts.
                  Create and manage project workflows, and access project
                ...
                <p>
                  ...
                  deployment pipelines running under the hood. This unique
                  feature allows for the rapid addition of new APIs, empowering
                  us to scale up the number of available automations in the
                  blink of an eye based on user feedback.
                </p>
                ...
                <p>
                  ...
                  <strong>single-command automations</strong>. We are committed
                  to empowering our users to create and customize intricate
                  workflows that align with the unique requirements of their
                  enterprises. This expansion is not a distant dream; it's a
                  part of our near-future roadmap.
                </p>
                ...
                <p>
                  <strong>
                    ...
                    Engines to enable automating business process workflows in
                    the near future just by using prompts.
                  </strong>
                </p>
